...
export const dsClasses = {
  ...
  cardHover: 'hover:bg-white/[0.02] hover:border-white/10 transition-all duration-150',
  ...
  buttonDanger: 'bg-red-600/20 hover:bg-red-600/30 text-red-300 border border-red-500/30',
  ...
  // Badges - less perfect
  badge: 'inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-[12px] font-medium border',
  ...
  // Inputs
  input: 'w-full px-3 py-2 rounded-md bg-white/5 border border-white/10 text-white placeholder-white/40 focus:border-white/30 focus:bg-white/[0.08] transition-colors duration-150',
